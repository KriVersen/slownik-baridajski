...
\newcommand{\prep}[3]{\markboth{#1}{#1}\textbf{#1} /\textipa{#2}/ \textsc{przyim.} #3 \\ }
\newcommand{\con}[3]{\markboth{#1}{#1}\textbf{#1} /\textipa{#2}/ \textsc{spój.} #3 \\ }
\newcommand{\adve}[3]{\markboth{#1}{#1}\textbf{#1} /\textipa{#2}/ \textsc{przysł.} #3 \\ }
\newcommand{\pron}[3]{\markboth{#1}{#1}\textbf{#1} /\textipa{#2}/ \textsc{zaim.} #3 \\ }
